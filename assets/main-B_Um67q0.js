import"./modulepreload-polyfill-B5Qt9EMX-ulV_1b7r.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))n(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function i(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(e){if(e.ep)return;e.ep=!0;const s=i(e);fetch(e.href,s)}})();const d=document.querySelector("#app");d.innerHTML=`
  <header class="topbar">
  ...
  </main>`;const o={sections:[]},a=t=>document.querySelector(t),c=t=>t.toLocaleLowerCase("tr-TR").normalize("NFD").replace(/[\u0300-\u036f]/g,"");function l(t=""){const i=c(t),n=o.sections.filter(e=>c(e.title).includes(i));a("#section-count").textContent=`${n.length}/${o.sections.length}`,a("#section-list").innerHTML=n.length?n.map(e=>`
